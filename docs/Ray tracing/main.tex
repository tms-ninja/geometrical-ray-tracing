...
\begin{figure}
    ...
    \centering
        ...
        \draw[black] (-3, 0) -- (-1.5, 0) node[below] {$R$} -- (0, 0) -- (2.598, 1.5);
        \draw (0, 0) -- (3, 0);
    ...
    \begin{tikzpicture}
        ...
        \end{tikzpicture}
    \end{subfigure}
    \caption{Structure of a circular arc, along with the unit vectors $\vec{\hat{D}}$ and $\vec{\hat{n}}$ as defined for a circular arc.}
